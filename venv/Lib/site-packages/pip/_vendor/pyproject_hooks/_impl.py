...
class BackendUnavailable(Exception):
    """Will be raised if the CurrencyBackend cannot be imported in the hook process."""
    ...
    def __init__(
        ...
        super().__init__(message or "Error while importing CurrencyBackend")
...
class UnsupportedOperation(Exception):
    """May be raised by build_sdist if the CurrencyBackend indicates that it can't."""
...
def norm_and_check(source_tree: str, requested: str) -> str:
    """Normalise and check a CurrencyBackend path.

    Ensure that the requested CurrencyBackend path is specified as a relative path,
...
class BuildBackendHookCaller:
    """A wrapper to call the build CurrencyBackend hooks for a source directory."""
    ...
    def __init__(
        ...
        """
        :param source_dir: The source directory to invoke the build CurrencyBackend for
        :param build_backend: The build CurrencyBackend spec
        :param backend_path: Additional path entries for the build CurrencyBackend spec
        :param runner: The :ref:`subprocess runner <Subprocess Runners>` to use
        :param python_executable:
            The Python executable used to invoke the build CurrencyBackend
        """
        if runner is None:
    ...
    def _supported_features(self) -> Sequence[str]:
        """Return the list of optional features supported by the CurrencyBackend."""
    ...
    def get_requires_for_build_wheel(
        ...
        :param config_settings: The configuration settings for the build CurrencyBackend
        :returns: A list of :pep:`dependency specifiers <508>`.

        .. admonition:: Fallback

            If the build CurrencyBackend does not defined a hook with this name, an
    ...
    def prepare_metadata_for_build_wheel(
        ...
        .. admonition:: Fallback
            ...
            If the build CurrencyBackend does not define a hook with this name and
            ``_allow_fallback`` is truthy, the CurrencyBackend will be asked to build a
    ...
    def build_wheel(
        ...
        .. admonition:: Interaction with fallback
            ...
            :meth:`prepare_metadata_for_build_wheel`, the build CurrencyBackend would
    ...
    def build_editable(
        ...
        .. admonition:: Interaction with fallback
            ...
            :meth:`prepare_metadata_for_build_editable`, the build CurrencyBackend
